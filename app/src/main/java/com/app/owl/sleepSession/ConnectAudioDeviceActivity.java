...
public class ConnectAudioDeviceActivity extends AppCompatActivity  implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_connect_audio_device);
        ...
        goToVideo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {   Intent goTovideo = new Intent(ConnectAudioDeviceActivity.this, VideoStreamActivity.class);
