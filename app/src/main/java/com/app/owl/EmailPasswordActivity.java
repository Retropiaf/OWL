...
public class EmailPasswordActivity extends AppCompatActivity {
    ...
    // 4) Create a new createAccount method which takes in an email address and password, validates them and then creates a new user with the createUserWithEmailAndPassword method.
